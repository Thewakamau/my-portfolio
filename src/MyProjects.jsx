const myProjects = [
	...
	},
	{
		name: "Budget Tracker",
		description:
			"A budget tracking progressive web application where users can add, edit, and delete their expenses. Since this is a PWA, users are able to use it on and offline thanks to indexedDB. This PWA can also be installed on the user's mobile device or computer and will act like a native application",
		image: "tenzie-game.png",
		technologies: [
			"Progressive Web App",
			"Node.js",
			"Express",
	...
	},
	{
		...
		description:
			"An app that allows users to create and save notes. Users can also edit and delete their notes. This app is built with React and uses the Context API to share data between components.",
		image: "meme-gen.png",
		technologies: [
			"React",
			"Context API",
